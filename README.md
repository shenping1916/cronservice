...
### 前言
随着后端架构的拆分，各种分布式系统越来越向着**微服务**的趋势发展，而有时服务又不得不跑一些定时任务，比如：报表生成、定时查询等，这个时候。在服务中写一些定时任务的代码，无疑增加了服务本身的一些负担。
按照这个想法，设计了此**统一定时任务中心**，部署在微服务架构中心。它将管理：所有服务定时任务的一切动作，而服务本身只要提供对应的rpc接口即可。
